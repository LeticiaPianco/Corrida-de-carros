class Game {
  ...
  showLife() {
    push();
    image(lifeImage, width / 2 - 300, height - player.positionY - 420, 20, 20);
    fill("white");
    rect(width / 2 - 270, height - player.positionY - 420, 185, 20);
    fill("#f50057");
    rect(width / 2 - 270, height - player.positionY - 420, player.life, 20);
    noStroke();
    pop();
  }
  ...
  showFuelBar() {
    push();
    image(fuelImage, width / 2 - 300, height - player.positionY - 390, 20, 20);
    fill("white");
    rect(width / 2 - 270, height - player.positionY - 390, 185, 20);
    fill("#ffc400");
    rect(width / 2 - 270, height - player.positionY - 390, player.fuel, 20);
    noStroke();
    pop();
  }
